    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['goods:secondhandGoods:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listSecondhandGoods, getSecondhandGoods, delSecondhandGoods, addSecondhandGoods, updateSecondhandGoods } from "@/api/goods/secondhandGoods";
