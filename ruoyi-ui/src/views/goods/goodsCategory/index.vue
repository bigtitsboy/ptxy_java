    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['goods:goodsCategory:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['goods:goodsCategory:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['goods:goodsCategory:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['goods:goodsCategory:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listGoodsCategory, getGoodsCategory, delGoodsCategory, addGoodsCategory, updateGoodsCategory } from "@/api/goods/goodsCategory";
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getGoodsCategory(categoryId).then(response => {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除商品分类编号为"' + categoryIds + '"的数据项？').then(function() {
        return delGoodsCategory(categoryIds);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('goods/goodsCategory/export', {
        ...this.queryParams
