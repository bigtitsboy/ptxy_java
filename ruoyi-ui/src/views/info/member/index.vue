  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="会员账号" prop="memberName">
          <el-input v-model="form.memberName" placeholder="请输入会员账号" />
        </el-form-item>
        <el-form-item label="会员昵称" prop="nickName">
...
<script>
import { listMember, getMember, delMember, addMember, updateMember } from "@/api/info/member";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('info/member/export', {
        ...this.queryParams
